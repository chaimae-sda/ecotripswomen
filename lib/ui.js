...
const FR = {
  ...
  // Garanties construites a partir des deux champs du voyage (delai
  // d'annulation, avance). Quand ils sont vides, ce sont les garanties ecrites
  // dans le Studio qui s'affichent, telles quelles.
  garantieAnnulation: "Annulation gratuite",
  garantieAnnulationUn: "Jusqu'à {n} jour avant le départ, remboursement intégral.",
  garantieAnnulationPlusieurs: "Jusqu'à {n} jours avant le départ, remboursement intégral.",
  garantieAvance: "Paiement flexible",
  garantieAvanceTexte: "Verse {montant} d'avance aujourd'hui, le reste avant le départ.",
...
const EN = {
  ...
  garantieAnnulation: "Free cancellation",
  garantieAnnulationUn: "Up to {n} day before departure, full refund.",
  garantieAnnulationPlusieurs: "Up to {n} days before departure, full refund.",
  garantieAvance: "Flexible payment",
  garantieAvanceTexte: "Pay {montant} today, the rest before departure.",
...
const DR = {
  ...
  garantieAnnulation: 'Annulation bla flous',
  garantieAnnulationUn: "7ta l {n} nhar 9bel lkhrouj, kanreddou lik flousek kamlin.",
  garantieAnnulationPlusieurs: "7ta l {n} dyal l'iyam 9bel lkhrouj, kanreddou lik flousek kamlin.",
  garantieAvance: 'Khlas 3la rahtek',
  garantieAvanceTexte: 'Khelsi {montant} daba, w lba9i 9bel lkhrouj.',
