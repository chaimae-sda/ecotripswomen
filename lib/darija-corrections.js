...
const CORRECTIONS = {
  ...
  // Pied de page. La premiere ligne et le mot rose qui la suit sont recolles
  // avant traduction ("on t'aide" + "à"), la cle est donc la ligne entiere; le
  // dernier mot repasse en rose ensuite.
